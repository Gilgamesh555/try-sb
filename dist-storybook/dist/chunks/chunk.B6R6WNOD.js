...
var Popup = class extends UIKitElement {
  constructor() {
    super(...arguments);
    this.active = false;
  ...
  render() {
    return html`
      ...
      >
        ${this.colorVariant === "unstyled" ? html`<slot></slot>` : html`<div
              class=${classMap({
      popup__body: true,
...
Popup.styles = [component_styles_default, popup_styles_default];
__decorateClass([
  query(".popup")
...
], Popup.prototype, "colorVariant", 2);
__decorateClass([
...
], Popup.prototype, "hoverBridge", 2);

export {
  Popup
};
//# sourceMappingURL=chunk.B6R6WNOD.js.map
