...
export async function discover(root) {
    ...
    const rootIsCustomElement = rootTagName === null || rootTagName === void 0 ? void 0 : rootTagName.includes('-');
    const tags = [...root.querySelectorAll(':not(:defined)')]
        .map(el => el.tagName.toLowerCase())
        .filter(tag => tag.startsWith('koerber-'));
...
function register(tagName) {
    const tagWithoutPrefix = tagName.replace(/^koerber-/i, '');
